...
<?php
	...
	echo form_open('admin/specialoffer-new', array('method' => 'post', 'id' => 'form1', 'name' => 'form1'));
				...
				<table class="list">
					<tr>
						...
						<td width="70%" class="td_value">
							<input name="offer_name" type="text" value="" />
						</td>
					</tr>
					<tr>
						...
						<td width="70%" class="td_value">
							<input name="offer_code" type="text" value="" />
						</td>
					</tr>
					<tr>
						...
						<td width="70%" class="td_value">
							<input name="offer_price" type="text" value="" />
						</td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td width="70%" class="td_value">
							<textarea name="extra_product" rows="5" cols="50" style="overflow:auto;"></textarea>
						</td>
					</tr>
				</table>
			</div>
